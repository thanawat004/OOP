...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        database[0] = new BankAccount("jim", "jim", 1111, 10000.0);
        database[1] = new BankAccount("sushi", "sushi", 2222, 5500.0);
        database[2] = new BankAccount("joe", "joe", 3333, 15000.0);
        database[3] = new BankAccount("bay", "bay", 4444, 20000.0);
        database[4] = new BankAccount("hiyuki", "hiyuki", 5555, 50000.0);
